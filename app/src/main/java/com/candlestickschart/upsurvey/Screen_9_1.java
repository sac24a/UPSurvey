...
public class Screen_9_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_screen_9_1);
        ...
        forward.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Screen_9_1.this, Screen_10.class);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                checkValue(brahmin.getText().toString(),"सुनार समाज");
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                checkValue(baniya.getText().toString(),"सैनी समाज");
            }
        });
        btn3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                checkValue(thakur.getText().toString(),"राजभर समाज");
            }
        });
        btn4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                checkValue(kayasth.getText().toString(),"नाई/सेन समाज");
            }
        });
    }
    public void checkValue(String voter,String socialType){
        AppExecutors.getInstance().diskIO().execute(new Runnable() {
            @Override
            public void run() {
                PollFirstDataBase pollFirstDataBase = PollFirstDataBase.getInstance(Screen_9_1.this);
                socialData = pollFirstDataBase.pollFirstDao().checkSocialData(socialType);
                if (socialData.size() == 0) {
                    Intent intent = new Intent(Screen_9_1.this, SocialPerson.class);
                    ...
                    AppExecutors.getInstance().mainThread().execute(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(Screen_9_1.this,"You have saved this data",Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
